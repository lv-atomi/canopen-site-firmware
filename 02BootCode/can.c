...
extern uint16_t gSysRamBuf[DLCBLOCK];
...
void USBFS_L_CAN1_RX0_IRQHandler (void)// CAN Receive interrupt handle function
{
  ...
  if(can_flag_get(CAN1,CAN_RF0MN_FLAG) != RESET)
  {
    can_message_receive(CAN1, CAN_RX_FIFO0, &rx_message_struct);
		...
		if((Rec_ID == BOOTLOADER_MASTERID)&& (REC_DLC == 8))
		{
			for (i=0; i<8; i++) 
			{
				gSysParm.canRxBuf[i] = rx_message_struct.data[i];
			}
      gSysParm.canRxCmd = CAN_RXD_BOOT; 			
		}
  }
}
...
{
//	uint16_t i;
//	gSysParm.basePara.CanDataId = BOOTLOADER_SLAVEID;
...
void can_transmit_req(uint8_t data1,uint8_t data2)
{
  uint8_t transmit_mailbox;
  can_tx_message_type tx_message_struct;
  tx_message_struct.standard_id = BOOTLOADER_SLAVEID;
  tx_message_struct.extended_id = 0;
  tx_message_struct.id_type = CAN_ID_STANDARD;
  tx_message_struct.frame_type = CAN_TFT_DATA;
  tx_message_struct.dlc = 8;
  tx_message_struct.data[0] = 0X52;
  tx_message_struct.data[1] = 0x44;
  tx_message_struct.data[2] = 0x59;
  tx_message_struct.data[3] = data1;
	tx_message_struct.data[4] = data2;
	tx_message_struct.data[5] = 0x08;  //2048 BYTE
	tx_message_struct.data[6] = 0x00;
	tx_message_struct.data[7] = 0x03;  //3ms

  transmit_mailbox = can_message_transmit(CAN1, &tx_message_struct);
  while(can_transmit_status_get(CAN1, (can_tx_mailbox_num_type)transmit_mailbox) != CAN_TX_STATUS_SUCCESSFUL);
}
uint16_t counter = 0;
void main_data_transmit()
{
	uint8_t i;
  ...
  can_tx_message_type tx_message_struct;
	...
	counter = (gSysParm.canRxBuf[0]<<8)|gSysParm.canRxBuf[1];
	for(i = 0; i < 6;i++)
	{
		gSysRamBuf[6*counter+i] = gSysParm.canRxBuf[2+i];
		checksum += gSysParm.canRxBuf[2+i];
	}
  ...
  tx_message_struct.frame_type = CAN_TFT_DATA;
  tx_message_struct.dlc = 8;
  tx_message_struct.data[0] = gSysParm.canRxBuf[0];
  tx_message_struct.data[1] = gSysParm.canRxBuf[1];
	tx_message_struct.data[6] = checksum>>8;
	tx_message_struct.data[7] = checksum; 
...
void Block_done()
{
	...
	uint8_t transmit_mailbox;
  can_tx_message_type tx_message_struct;
	counter = (gSysParm.canRxBuf[3]<<8)|gSysParm.canRxBuf[4];
	err_status = flash_write(BACKUPADDRESS+counter*2048, gSysRamBuf, DLCBLOCK);	
  ...
  tx_message_struct.frame_type = CAN_TFT_DATA;
  tx_message_struct.dlc = 8;
  tx_message_struct.data[0] = 0x44;
  tx_message_struct.data[1] = 0x4f;
	tx_message_struct.data[2] = 0x45;
	tx_message_struct.data[3] = gSysParm.canRxBuf[3]; 
	tx_message_struct.data[3] = gSysParm.canRxBuf[4]; 
...
void Block_copy()
{
	...
	{
		flash_read(BACKUPADDRESS, gSysRamBuf, DLCBLOCK);
		err_status = flash_write(INITADDRESS+i*2048, gSysRamBuf, DLCBLOCK);	
	}
	if(i == TOTALBLOCK - 1)
	{
		uint8_t transmit_mailbox;
		...
		tx_message_struct.frame_type = CAN_TFT_DATA;
		tx_message_struct.dlc = 8;
		tx_message_struct.data[0] = 0x43;
		tx_message_struct.data[1] = 0x4f;
		tx_message_struct.data[2] = 0x4d;
		tx_message_struct.data[3] = 0x50; 
		tx_message_struct.data[4] = 0x4c; 
		tx_message_struct.data[5] = 0x45; 
		tx_message_struct.data[6] = 0x54; 
		tx_message_struct.data[7] = 0x4c; 
...
void Relay_Reset()
{
		...
		tx_message_struct.frame_type = CAN_TFT_DATA;
		tx_message_struct.dlc = 8;
		tx_message_struct.data[0] = 0x47;
		tx_message_struct.data[1] = 0x4f;
		tx_message_struct.data[2] = 0x54;
		tx_message_struct.data[3] = 0x4f; 
		tx_message_struct.data[4] = 0x41; 
		tx_message_struct.data[5] = 0x50; 
		tx_message_struct.data[6] = 0x50; 
