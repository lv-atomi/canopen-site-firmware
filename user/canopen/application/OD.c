...
OD_ATTR_test OD_test_t OD_test = {
    .x6412_lvtest = 0x00000000
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6412, 0x01, ODT_VAR, &ODObjs.o_6412_lvtest, NULL},
