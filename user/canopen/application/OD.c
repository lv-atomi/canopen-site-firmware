...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2120_demoRecord = {
        {
            .dataOrig = &OD_RAM.x2120_demoRecord.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2120_demoRecord.I64,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
            .dataLength = 8
        },
        {
            .dataOrig = &OD_RAM.x2120_demoRecord.U64,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
            .dataLength = 8
        },
        {
            .dataOrig = &OD_RAM.x2120_demoRecord.R32,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2120_demoRecord.R64,
            .subIndex = 4,
            .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
            .dataLength = 8
        },
        ...
        {
            .dataOrig = &OD_RAM.x2120_demoRecord.parameterWithDefaultValue,
            .subIndex = 6,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_2121_demoStrings = {
        {
            .dataOrig = &OD_RAM.x2121_demoStrings.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2121_demoStrings.stringShort[0],
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_STR,
            .dataLength = 3
        },
        {
            .dataOrig = &OD_RAM.x2121_demoStrings.stringLong[0],
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_STR,
            .dataLength = 110
        },
        {
            .dataOrig = &OD_RAM.x2121_demoStrings.octetString[0],
            .subIndex = 3,
            .attribute = ODA_SDO_RW,
            .dataLength = 3
        }
    ...
    .o_6412_PSU_CurrentRead = {
        .dataOrig = &OD_RAM.x6412_PSU_CurrentRead,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataLength = 4
    },
    .o_6413_PSU_VoltageRead = {
        .dataOrig = &OD_RAM.x6413_PSU_VoltageRead,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataLength = 4
    },
    .o_6414_PSU_CurentSet = {
        .dataOrig = &OD_RAM.x6414_PSU_CurentSet,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
